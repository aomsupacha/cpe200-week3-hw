...
public class Course {
    ...
    public Course(String n, String cid, String l, int max) {
        this.course_name =   !n.equalsIgnoreCase("")?n:"TBA"; //If n don't empty return n else return false
        this.course_id = cid;
        this.lecturer = l;
    ...
    public String toString() {
        ...
        if(no_students==0){
            y = "NO student" + ", [maximum: " +max_students+"]";
        }
        else if(no_students==1){
            y = "ONE student"  + ", [maximum: "+max_students+"]";
        }
        else{
            y = no_students + " students" +", [maximum: "+max_students+"]";
        }
        String o = this.course_name + " (" + this.course_id + "), Teacher: " + this.lecturer + ", has " +y;
        return o;
    }
